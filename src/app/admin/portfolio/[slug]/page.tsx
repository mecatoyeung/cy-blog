...
import { PortfolioProjectEditor } from "@/components/admin/portfolio-project-editor";
import { ButtonLink } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { hasAdminPasswordConfigured, isAdminAuthenticated } from "@/lib/admin-auth";
import { getPortfolioProjectBySlug } from "@/lib/db";
  ...
  return (
    <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-4 py-8 sm:px-6 md:px-12 md:py-10">
      <section className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight">Edit Portfolio Project</h1>
      ...
      <Card>
        <CardContent className="pt-6">
          <PortfolioProjectEditor initialProject={project} />
        </CardContent>
      </Card>
    </main>
  );
